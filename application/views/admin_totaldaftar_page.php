...
<body>
	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">Halaman Admin PSB SMK BIM</a>
			</div>
	...
	<div class="container-fluid">
		<table class="table table-hover table-bordered">
			...
			<a href="<?php echo base_url() ?>index.php/admin/cetak_excel" class="btn btn-default btn-sm">Ekspor Exel<i class="fa fa-database"></i></a>
