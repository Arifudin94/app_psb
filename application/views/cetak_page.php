...
foreach ($data as $row) {
	...
	<div class="container cetak">
		...
		<footer class="text-center">
			<p>Silahkan cetak dan simpan bukti pendaftaran ini dengan baik karena akan digunakan untuk verifikasi selanjutnya. 
			Jika hilang dapat dicetak kembali dengan melakukan login pada PSB SMK BIM</p>
		</footer>
		<?php } ?>
	</div>
</body>
